    ...
    questions: [
      {
        ...
        contentSegments: [
          ...
          { kind: "link", value: "Forbrukskalkulator", to: "/kalkulator" },
          {
            kind: "text",
            value:
              " for å beregne hvor mye du kan spare, eller ta kontakt hvis du trenger hjelp til å vurdere løsningen.",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        a: "Vi tilbyr 1-fasemodeller for mindre behov og 3-fasemodeller for større installasjoner.",
        contentSegments: [
          { kind: "text", value: "Bruk " },
          { kind: "link", value: "Bøttemetoden", to: "/velg-modell" },
          {
            kind: "text",
            value:
              " for å beregne riktig modell basert på ditt forbruk. Ta gjerne kontakt dersom du ønsker hjelp til å vurdere hvilken løsning som passer best.",
          },
        ],
      },
    ],
