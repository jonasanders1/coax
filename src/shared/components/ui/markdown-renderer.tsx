...
export function MarkdownRenderer({ children }: MarkdownRendererProps) {
  const normalizedContent = normalizeMarkdown(children)
...
const HighlightedPre = React.memo(
  ({ children, language, ...props }: HighlightedPreProps) => {
    ...
    return <pre {...props}>{highlighted}</pre>
  }
)
...
const COMPONENTS = {
  ...
  code: ({ children, className, node, ...rest }: React.ComponentPropsWithoutRef<"code"> & { node?: unknown }) => {
...
function withClass(Tag: keyof JSX.IntrinsicElements, classes: string) {
  // Type assertion needed because Tag can be any HTML element, and TypeScript
